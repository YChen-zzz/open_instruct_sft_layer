...
df = pd.read_parquet("/chenyupeng/old_files/yupeng_gpt/lit_gpt/litgpt-main/litgpt/finetune/tiny-pajama-parquet/000.parquet")
...
# 指定要存储的 JSON 文件路径
file_path = args.output_path + '/pajama_loss.json'
