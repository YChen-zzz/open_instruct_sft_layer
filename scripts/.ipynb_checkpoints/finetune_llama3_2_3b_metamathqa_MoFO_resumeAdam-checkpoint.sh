...
base_output_path=/chenyupeng/model_files/openinstruct/llama32_3B_2e_2e-5_mofo015_resumeAdam_from360
...
accelerate launch \
    ...
    --optimizer_set_alpha_after_resume 1.0 \
    --resume_from_checkpoint "/chenyupeng/model_files/openinstruct/llama32_3B_2e_2e-5_mofo015/finetune/step_360_state" \
    --use_AdamW_MoFO True \
    --MoFO_fraction 0.15 \
